...
export const THREATS: Threat[] = [
  ...
  t('TM-029', 'Event Worker ownership is undefined for incident response', 'Repudiation', 'CMP-06', 'Medium', 'Medium', 'medium', ['CTRL-34'], ['FIND-104'], ['EV-040']),
  ...
  t('TM-046', 'Queue ingest accepts a second producer without a delivery identity', 'Tampering', 'CMP-05', 'Medium', 'Medium', 'medium', ['CTRL-30'], ['FIND-107'], ['EV-041']),
  {
  ...
  t('TM-034', 'Gateway 5xx response reveals internal queue naming', 'Information Disclosure', 'CMP-02', 'Low', 'Low', 'low', ['CTRL-13'], [], ['EV-041']),
  ...
  t('TM-050', 'Upstream retry storm saturates the payment event queue', 'Denial of Service', 'CMP-05', 'Low', 'Medium', 'low', ['CTRL-03', 'CTRL-24'], [], ['EV-041']),
]
...
export const CONTROLS: Control[] = [
  ...
  c('CTRL-03', 'Edge rate limiting per client and per route', 'Network', 'Partial', ['CMP-02'], 'EV-038'),
  ...
  c('CTRL-07', 'Two-reviewer approval on production deploys', 'Governance', 'Implemented', ['CMP-03', 'CMP-06'], 'EV-025'),
  c('CTRL-08', 'Egress allowlist for application subnets', 'Network', 'Partial', ['CMP-03', 'CMP-06'], 'EV-038'),
  c('CTRL-09', 'Automated credential rotation (90-day maximum)', 'Identity', 'Implemented', ['CMP-03'], 'EV-030'),
  ...
  c('CTRL-16', 'Static application security testing on every pull request', 'Application', 'Implemented', ['CMP-03', 'CMP-06'], 'EV-025'),
  c('CTRL-17', 'Dependency vulnerability gate at build time', 'Application', 'Implemented', ['CMP-03', 'CMP-06'], 'EV-025'),
  c('CTRL-18', 'Server-side authorization on every money-moving route', 'Application', 'Implemented', ['CMP-03'], 'EV-034'),
  c('CTRL-19', 'Signed container images with admission verification', 'Application', 'Implemented', ['CMP-03', 'CMP-06'], 'EV-025'),
  c('CTRL-20', 'Network segmentation between edge and application subnets', 'Network', 'Implemented', ['CMP-02', 'CMP-03'], 'EV-038'),
  c('CTRL-21', 'Secrets manager with no plaintext secrets in source', 'Data', 'Implemented', ['CMP-03', 'CMP-06'], 'EV-038'),
  ...
  c('CTRL-34', 'Documented service ownership and on-call rotation', 'Governance', 'Planned', ['CMP-06'], 'EV-040'),
  c('CTRL-35', 'Annual penetration test of the payment surface', 'Governance', 'Implemented', ['CMP-02', 'CMP-03'], 'EV-031'),
  c('CTRL-36', 'Threat-model review gate before production launch', 'Governance', 'Implemented', ['CMP-03'], 'EV-030'),
